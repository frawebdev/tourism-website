...
if(get_field('disponibile', 'category_' . $args['settimane']) == true){
...
?>
    ...
    <div class="container d-flex flex-column flex-sm-row align-items-center justify-content-between mb-5" style="border-bottom: 3px solid #6e32d2" data-aos="fade-up" data-aos-duration="700">
        <div class="container text-sm-left text-center">
            <p class="text-muted mb-1">dal <?php echo get_field('inizio', 'category_' . $args['settimane']); ?> al <?php echo get_field('fine', 'category_' . $args['settimane']); ?></p>
            <h2 class="mb-1"><a style="font-weight: bolder;" class="read-more" href="<?php echo get_category_link($args['settimane']); ?>"><?php echo get_cat_name($args['settimane']); ?></a></h2>
        </div>
...
?>
    ...
    <div class="container text-sm-left text-center">
        <p class="text-muted mb-1" style="color: rgba(172, 171, 173, 0.603);">dal <?php echo get_field('inizio', 'category_' . $args['settimane']); ?> al <?php echo get_field('fine', 'category_' . $args['settimane']); ?></p>
        <h2 class="mb-1"><a style="font-weight: bolder;" class="read-more" href="<?php echo get_category_link($args['settimane']); ?>"><?php echo get_cat_name($args['settimane']); ?></a></h2>
    </div>
    <div>
